                ...
                <div class="card-body">
                    <form action="{{ route('etudiants.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('date_debut_stage') is-invalid @enderror" 
                                           id="date_debut_stage" name="date_debut_stage" value="{{ old('date_debut_stage') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('date_fin_stage') is-invalid @enderror" 
                                           id="date_fin_stage" name="date_fin_stage" value="{{ old('date_fin_stage') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">JPG, JPEG, PNG, GIF up to 1MB</div>
                            @error('photo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
